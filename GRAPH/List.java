 ...
 * 		List(boolean enableNull) 			- toggles insertion of null object<p>
 * 		List(List<? extends E> list) 		- constructs a list containing the elements of the specified list<p>
 * 		List()								- constructs empty list<p>
 * 
 * Method Summary:<p>
 * 		add(List<? extends E> list)			- appends to this list containing the elements of the specified list<p>
 * 		append(E data)						- appends the specified element to the end of this list<p>
 * 		removeAll(E data)					- removes all elements of the specified element from this list<p>
 * 		removeAll()							- removes all elements of the list<p>
 * 		remove(E data)						- removes the first occurence of the specified element from this list<p>
 * 		pop(int index)						- removes an element based on index where it is located from this list<p>
 * 		print()								- prints elements in the list<p>
 * 		isExisting(E data)					- returns boolean indicates existence of the argument<p>
 * 		toString()							- returns string of elements in the list<p>
 * 		getIndex(E data)					- returns index address of corresponding element argument<p>
...
public class List<E> {
	 ...
	 */
	public boolean isExisting(E e1) {
		for (E e : MAIN_LIST) {
			if (e == e1) {
				return true;
			}
